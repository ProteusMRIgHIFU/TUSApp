...
def initLog(fus, name):
	...
	fus.setLogLevel (FUSTHON.LogLevel.INFO)


def connect(fus,generatorFile="generator_Calgary_128.ini"):
    ...
    print('os.path.exists (generatorFile)',generatorFile,os.path.exists (generatorFile))
...
class ExecListener(FUSTHON.FUSListener):
    ...
    def onConnectStart(self):
        print ("Listener: OPENING CONNECTION")
